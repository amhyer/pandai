...
import { SiswaDashboardEnhancement } from '@/components/views/siswa/siswa-dashboard-enhancement';
import {
  BarChart3,
  Target,
  Trophy,
...
export function SiswaDashboard() {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen -m-4 sm:-m-6 lg:-m-8 p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      {/* ── Enhancement: Kesiapan TKA + Diagnostik + Catatan Guru + Kuis ── */}
      <SiswaDashboardEnhancement />
