...
import { useAppStore, ViewType } from '@/store/use-store';
    ...
    switch (currentView) {
      ...
      case 'settings':
        return user?.role === 'SUPER_ADMIN'
          ? <PlaceholderPage title="Pengaturan" desc="Konfigurasi platform PANDAI — nama, logo, KKM global, dll." />
          : <PlaceholderPage title="Pengaturan" desc="Halaman dalam pengembangan" />;
