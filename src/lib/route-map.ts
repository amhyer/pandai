...
/**
 * Maps an App Router pathname directly to the legacy `currentView`.
 * Used by the URL-first ViewRouter so migrated routes do not depend on the
 * store's initial view state.
 */
const PATHNAME_VIEWS: Record<string, ViewType> = {
  ...
  '/accounts/analytics': 'analytics-global',
  '/accounts/reports': 'reports-global',
  ...
  '/admin-school/teacher-assignments': 'teacher-assignments',
  '/admin-school/timetable': 'timetable',
  '/admin-school/wali-kelas': 'wali-kelas',
  '/admin-school/import-csv': 'import-csv',
  '/admin-school/dapodik-sync': 'dapodik-sync',
  '/admin-school/settings': 'settings',
  '/admin-school/backup-restore': 'backup-restore',
  '/admin-school/activity-log': 'activity-log',
  '/admin-school/questions': 'questions',
  '/admin-school/question-editor': 'question-editor',
  '/admin-school/exams': 'exams',
  '/admin-school/exam-assignments': 'exam-assignments',
  '/admin-school/results': 'results',
  '/admin-school/analytics': 'analytics',
  '/admin-school/reports': 'reports',
  '/admin-school/profile': 'profile',
  '/admin-school/notifications': 'notifications',
  ...
  '/guru/komponen-nilai': 'guru-komponen-nilai',
  '/guru/rapor': 'guru-rapor',
  '/guru/settings': 'settings',
  '/guru/profile': 'profile',
  '/guru/notifications': 'notifications',
  ...
  '/siswa/nilai-akhir': 'siswa-nilai-akhir',
  '/siswa/rapor': 'siswa-rapor',
  '/siswa/diagnostic': 'diagnostic',
  '/siswa/practice': 'practice',
  '/siswa/exam-runner': 'exam-runner',
  '/siswa/leaderboard': 'leaderboard',
  '/siswa/settings': 'settings',
  '/siswa/profile': 'profile',
  '/siswa/notifications': 'notifications',
  ...
  '/ortu/nilai-akhir': 'ortu-nilai-akhir',
  '/ortu/rapor': 'ortu-rapor',
  '/ortu/settings': 'settings',
  '/ortu/profile': 'profile',
  '/ortu/notifications': 'notifications',
  '/ortu/broadcasts': 'broadcasts',

  '/kepala-sekolah': 'dashboard-kepsek',
  '/kepala-sekolah/dashboard': 'dashboard-kepsek',
  '/kepala-sekolah/peta-kelas': 'kepsek-peta-kelas',
  '/kepala-sekolah/rekap-kelas': 'kepsek-rekap-kelas',
  '/kepala-sekolah/rekap-guru': 'kepsek-rekap-guru',
  '/kepala-sekolah/rekap-karakter': 'kepsek-rekap-karakter',
  '/kepala-sekolah/kotak-masukan': 'kepsek-kotak-masukan',
  '/kepala-sekolah/profil-lulusan': 'kepsek-profil-lulusan',
  '/kepala-sekolah/rapor': 'kepsek-rapor',
  '/kepala-sekolah/settings': 'settings',
  '/kepala-sekolah/profile': 'profile',
  '/kepala-sekolah/notifications': 'notifications',
  '/kepala-sekolah/broadcasts': 'broadcasts',
};

export function viewFromPathname(pathname: string): ViewType | null {
  return PATHNAME_VIEWS[pathname] ?? null;
}
