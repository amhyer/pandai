...
function KepalaSekolahAccountsPage() {
  ...
  // Kepala Sekolah bisa melihat akun di sekolah mereka
  const effectiveSchoolId = selectedSchoolId || user.schoolId;

  // Filter users untuk kepala sekolah - semua akun di sekolah
                ...
                <TableRow key={u.id} className="hover:bg-muted/50">
                  ...
                  <TableCell>
                    {u.role === 'GURU' ? 'Guru' :
                      ...
                      u.role === 'ADMIN_SCHOOL' ? 'Admin Sekolah' : 'Lainnya'}
                  </TableCell>
                  <TableCell>
                    <span
...
export default KepalaSekolahAccountsPage;