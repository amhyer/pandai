...
export async function GET(request: Request) {
  try {
    ...
    if (type === 'global') {
      ...
      const monthlyGrowth = [
        { month: 'Jul', sekolah: 2, siswa: 45 }, { month: 'Agu', sekolah: 5, siswa: 120 },
        { month: 'Sep', sekolah: 8, siswa: 210 }, { month: 'Okt', sekolah: 12, siswa: 340 },
        { month: 'Nov', sekolah: 15, siswa: 480 }, { month: 'Des', sekolah: totalSchools, siswa: totalStudents },
      ];
